...
#ifndef PIXIE_NET_FIPPICONFIGURATION_HPP
#define PIXIE_NET_FIPPICONFIGURATION_HPP

#include "PixieNetDefs.hpp"

/** Class that represents information used to program the FPGA.
...
public:
   ...
   */
    ...
    */
    ...
    unsigned int THRESH_ADC_AVG[NCHANNELS];//             0      0
};


#endif //PIXIE_NET_FIPPICONFIGURATION_HPP
